...
QT_MOC_LITERAL(1, 10, 12), // "createButton"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 37, 5) // "event"

    },
    "MyQbutton\0createButton\0\0QMouseEvent*\0"
    "event"
};
...
void MyQbutton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->createButton((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyQbutton::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQbutton::createButton)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQbutton::createButton(QMouseEvent * _t1)
{
