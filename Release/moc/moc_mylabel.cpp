...
QT_MOC_LITERAL(1, 8, 20), // "deleteLabelrequested"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "MyLabel*"
QT_MOC_LITERAL(4, 39, 6), // "button"
QT_MOC_LITERAL(5, 46, 7), // "beWhite"
QT_MOC_LITERAL(6, 54, 5) // "beRed"

    },
    "MyLabel\0deleteLabelrequested\0\0MyLabel*\0"
    "button\0beWhite\0beRed"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteLabelrequested((*reinterpret_cast< MyLabel*(*)>(_a[1]))); break;
        case 1: _t->beWhite(); break;
        case 2: _t->beRed(); break;
        default: ;
        }
        ...
        {
            using _t = void (MyLabel::*)(MyLabel * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::deleteLabelrequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::deleteLabelrequested(MyLabel * _t1)
{
